...
var CalendarHeatMap = function (_React$Component) {
  ...
  function CalendarHeatMap() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CalendarHeatMap.__proto__ || Object.getPrototypeOf(CalendarHeatMap)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
    ...
    }, _this.getMonthComponents = function (streakData, maxCount, color, size, tooltipText, dataIndex) {
      var months = [];
      for (var i = 11; i >= 0; i--) {
      ...
      var _this$props = _this.props,
          ...
          size = _this$props$size === undefined ? 'default' : _this$props$size,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _this.getMonthComponents(streakData, maxCount, color, size, tooltipText, dataIndex)
        ),
